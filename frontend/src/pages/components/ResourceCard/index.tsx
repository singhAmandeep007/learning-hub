  ...
  const getTypeIcon = (type: ResourceType) => {
    switch (type) {
      case RESOURCE_TYPES.video:
        return (
          <Video className="resource-card-type-icon resource-card-type-icon-video" />
        );
      case RESOURCE_TYPES.pdf:
        return (
          <File className="resource-card-type-icon resource-card-type-icon-pdf" />
        );
      case RESOURCE_TYPES.article:
        return (
          <ExternalLink className="resource-card-type-icon resource-card-type-icon-article" />
        );
      default:
